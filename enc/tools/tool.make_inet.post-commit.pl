...
system $svn." export -q --force --username=fargroup --password=secret svn://localhost/svn/trunk/enc/tools/inet/ ".$dest_dr_inet."/inet";
...
sub mk_inet_lng
{
  ...
  print " -- preparing ".$dr1." --\n";
  system $svn." export -q --force --username=fargroup --password=secret svn://localhost/svn/trunk/enc/enc_".$dr2." ".$dest_dr_inet."/meta.".$dr1;
