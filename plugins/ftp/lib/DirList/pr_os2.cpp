 ...
 * 07-13-102   21:39
 */
BOOL net_parse_os_date_time( CONSTSTR datestr, Time_t& decoded )
{
...
*/
BOOL DECLSPEC idPRParceOS2( const PFTPServerInfo Server, PFTPFileInfo p, char *entry, int entry_len )
