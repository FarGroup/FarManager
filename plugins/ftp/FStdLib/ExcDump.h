...
/** @mainpage ExcDump library
    ...
    @note In case you use dynamic loading you must call HEX_Cleanup() function manually before unload library DLL.
    @note In case you use HEX_DumpInfo structure to access library functions you should noth that library uses
          1-byte alignment structures;
...
//  Interface
//----------------------------------------
#define HEX_VER_00          22012003
#define HEX_VERSION         HEX_VER_00
