...
void FTP::GetCurPath( String& buff )
  {
    ...
    if ( !FtpGetCurrentDirectory( hConnect,buff ) )
      buff.Null();
}
...
int FTP::ExpandList( PluginPanelItem *pi,int icn,PFP_SizeItemList il,BOOL FromPlugin,ExpandListCB cb,LPVOID Param )
...
//---------------------------------------------------------------------------------
BOOL FTP::FTP_SetDirectory( CONSTSTR dir,BOOL FromPlugin )
...
//---------------------------------------------------------------------------------
int FTP::ExpandListINT( PluginPanelItem *pi,int icn,PFP_SizeItemList il,BOOL FromPlugin,ExpandListCB cb,LPVOID Param )
