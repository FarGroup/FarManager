...
#define MACROVIEWCOPYRIGHT "Copyright © Konstantin Melnikov 1998-2007, Copyright © 2007-2008 FAR Group\000\000"
#define FARPRODUCTNAME "FAR manager\000"
#define FARPRODUCTVERSION "1.71\000"
