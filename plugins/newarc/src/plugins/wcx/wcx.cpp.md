...
- `OnGetArchiveFormat()`: Event handler invoked when GetArchiveFormat occurs
### Summary
...
- `OnGetArchiveFormat()`: Procedura obsługi zdarzeń wywoływana gdy GetArchiveFormat występuje
### Podsumowanie
