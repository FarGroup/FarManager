...
- `OnExtract()`: Event handler invoked when Extract occurs
- `OnTest()`: Event handler invoked when Test occurs
### Summary
...
- `OnExtract()`: Procedura obsługi zdarzeń wywoływana gdy Extract występuje
- `OnTest()`: Procedura obsługi zdarzeń wywoływana gdy Test występuje
### Podsumowanie
