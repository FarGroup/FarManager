...
static int editor_Editor(lua_State *L)
{
	...
	intptr_t StartLine = luaL_optinteger(L, 8, 0) - 1;
	intptr_t StartChar = luaL_optinteger(L, 9, 0) - 1;
                              ...
                              void *Param)
{
	...
	Data->err = lua_pcall(L, 2, LUA_MULTRET, 0);
...
static int far_RecursiveSearch(lua_State *L)
{
	...
	return Data.err ? 0 : lua_gettop(L) - nret;
}
