...
public:
  ...
  void set_time(const FILETIME& ctime, const FILETIME& atime, const FILETIME& mtime, const FILETIME& chtime);
  bool set_time_nt(const FILETIME& ctime, const FILETIME& atime, const FILETIME& mtime, const FILETIME& chtime) noexcept;
