...
//- CONSOLE CHARACTERS
    ...
    #define FULL_CHAR                        '\xDB' //Û
    #define VERT_CHAR                        '\xB3' //³
    #define DVERT_CHAR                       '\xBA' //º
    #define HORZ_CHAR                        '\xC4' //Ä
    #define DHORZ_CHAR                       '\xCD' //Í
    #define CHECK_CHAR                       '\xFb' //û
    #define SBMENU_CHAR                      '\x10' //
    #define LEFT_CHAR                        '\x11' //
    #define RIGHT_CHAR                       SBMENU_CHAR
    #define SPACE_CHAR                       '\xFA' //ú
    #define TAB_CHAR                         '\xFE' //þ
