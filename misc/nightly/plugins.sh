...
bplugin "network" "Network" "Network.dll NetEng.hlf NetRus.hlf NetPol.hlf NetEng.lng NetPol.lng NetRus.lng NetSky.lng NetSpa.lng NetIta.lng NetBel.lng Network.map" && \
