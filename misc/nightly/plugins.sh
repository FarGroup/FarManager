...
( \
bplugin "align" "Align" "Align.dll AlignEng.lng AlignRus.lng AlignSky.lng AlignSpa.lng AlignIta.lng AlignPol.lng AlignBel.lng AlignGer.lng Align.map" && \
bplugin "autowrap" "AutoWrap" "AutoWrap.dll WrapEng.lng WrapRus.lng WrapSky.lng WrapSpa.lng WrapIta.lng WrapPol.lng WrapBel.lng WrapGer.lng AutoWrap.map" && \
bplugin "brackets" "Brackets" "Brackets.dll BrackEng.hlf BrackRus.hlf BrackPol.hlf BrackEng.lng BrackRus.lng BrackSky.lng BrackSpa.lng BrackIta.lng BrackPol.lng BrackBel.lng BrackGer.lng Brackets.lua Brackets.map" && \
bplugin "compare" "Compare" "Compare.dll CmpEng.hlf CmpRus.hlf CmpPol.hlf CmpGer.hlf CompEng.lng CompRus.lng CompSky.lng CompSpa.lng CompIta.lng CompPol.lng CompBel.lng CompGer.lng Compare.map AdvCompare.CompareBufferSize.farconfig" && \
bplugin "drawline" "DrawLine" "DrawLine.dll DrawEng.hlf DrawRus.hlf DrawPol.hlf DrawEng.lng DrawRus.lng DrawSky.lng DrawSpa.lng DrawIta.lng DrawPol.lng DrawBel.lng GrawGer.lng DrawLine.map" && \
bplugin "editcase" "EditCase" "EditCase.dll ECaseEng.hlf ECaseRus.hlf ECasePol.hlf EcaseGer.hlf ECaseEng.lng ECaseRus.lng ECaseSky.lng ECaseSpa.lng ECaseIta.lng ECasePol.lng ECaseBel.lng EcaseGer.lng EditCase.map" && \
...
bplugin "filecase" "FileCase" "FileCase.dll CaseEng.hlf CaseRus.hlf CasePol.hlf CaseGer.hlf CaseEng.lng CaseRus.lng CaseSky.lng CaseSpa.lng CaseIta.lng CasePol.lng CaseBel.lng CaseGer.lng FileCase.map" && \
...
bplugin "network" "Network" "Network.dll NetEng.hlf NetRus.hlf NetPol.hlf NetGer.hlf NetEng.lng NetRus.lng NetSky.lng NetSpa.lng NetIta.lng NetBel.lng NetPol.lng NetGer.lng Network.map" && \
bplugin "proclist" "ProcList" "ProcList.dll ProcEng.hlf ProcRus.hlf ProcPol.hlf ProcGer.hlf ProcEng.lng ProcRus.lng ProcIta.lng ProcBel.lng ProcPol.lng ProcGer.lng ProcList.map" && \
bplugin "tmppanel" "TmpPanel" "TmpPanel.dll TmpEng.hlf TmpRus.hlf TmpPol.hlf TmpGer.hlf TmpEng.lng TmpRus.lng TmpSky.lng TmpSpa.lng TmpIta.lng TmpPol.lng TmpBel.lng TmpGer.lng TmpPanel.map shortcuts.eng.lua shortcuts.rus.lua shortcuts.pol.lua shortcuts.bel.lua disks.eng.temp disks.rus.temp disks.pol.temp disks.bel.temp shortcuts.eng.temp shortcuts.rus.temp shortcuts.bel.temp TmpPanel.ListUTF8.farconfig" && \
