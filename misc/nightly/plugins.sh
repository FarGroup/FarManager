...
bplugin "luamacro" "LuaMacro" "LuaMacro.dll _globalinfo.lua api.lua luamacro.lua macrotest.lua utils.lua mbrowser.lua lang.lua panelsort.lua winapi.lua farapi.lua moonscript.lua lm_eng.lng lm_rus.lng lm_sky.lng lm_spa.lng LuaMacro.map" \
) || exit 1
