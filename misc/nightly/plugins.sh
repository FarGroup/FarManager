...
bplugin "luamacro" "LuaMacro" "LuaMacro.dll _globalinfo.lua api.lua luamacro.lua macrotest.lua utils.lua mbrowser.lua lang.lua lm_eng.lng lm_rus.lng LuaMacro.map" \
) || exit 1
