...
bplugin "compare" "Compare" "Compare.dll CmpEng.hlf CmpRus.hlf CompEng.lng CompRus.lng CompSky.lng CompSpa.lng Compare.map AdvCompare.CompareBufferSize.farconfig" && \
