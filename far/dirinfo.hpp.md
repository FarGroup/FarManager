...
### Key Classes
- `BasicDirInfoData`: Implements core functionality
- `DirInfoData`: Implements core functionality
- `PluginPanelItem`: Implements core functionality
- `UserDataItem`: Implements core functionality
...
### Kluczowe Klasy
- `BasicDirInfoData`: Implementuje podstawowa funkcjonalność
- `DirInfoData`: Implementuje podstawowa funkcjonalność
- `PluginPanelItem`: Implementuje podstawowa funkcjonalność
- `UserDataItem`: Implementuje podstawowa funkcjonalność
