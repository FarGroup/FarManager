...
параметров.
   ...
   #Атрибуты#        Атрибуты включения и атрибуты исключения.
                   ...
                   только на дисках с файловой системой NTFS. При этом
                   атрибуты #Зашифрованный# и #Автономный# используются
                   только в Windows 2000/XP/2003/Vista/2008.
...
"Временный", "Символическая связь" и "Автономный" используются только на дисках 
с файловой системой NTFS. Причем, атрибуты "Зашифрованный", 
"Символическая связь" и "Автономный" используются только в 
...
папки" будет недоступна.
    ...
    Атрибуты "Сжатый", "Зашифрованный", #Неиндексируемый#, #Разреженный#,
#Временный# и #Автономный# могут быть изменены только на дисках с файловой
системой NTFS. Причем, атрибуты "Зашифрованный" и "Автономный" используются
только в Windows 2000/XP/2003/Vista/2008. Атрибуты "Сжатый" и "Зашифрованный"
являются взаимоисключающими, т.е. можно выставить только один из них.
...
файла, панель файлов будет отображаться в многоколоночной форме.
    ...
    Порядок отображения атрибутов - RSHALCTIO. Символ атрибута 
"Разреженный" применяется только для файлов и ставится вместо 'L'. 
Символ атрибута "Зашифрованный" ставится вместо 'C', т.к. файл/каталог 
не могут иметь одновременно оба атрибута ("Сжатый" и "Зашифрованный"). 
По умолчанию размер колонки атрибутов - 6 символов. Для отображения 
дополнительных атрибутов 'T', 'I' и 'O' необходимо явно указать размер 
колонки в 9 символов.
