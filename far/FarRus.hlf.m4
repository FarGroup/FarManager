...
параметров.
   ...
   #Атрибуты#        Атрибуты включения и атрибуты исключения.
                   ...
                   только в Windows 2000/XP/2003/Vista/2008/7. Атрибут
                   #Виртуальный# используется только в Windows Vista/2008/7.
...
является ~панелью файлов~@FilePanel@, ее тип будет изменен на панель файлов.
    ...
    - извлечения дисков из CD-ROM и сменных приводов. В Windows
      NT/2000/XP/2003/Vista/2008/7 для операции извлечения диска из ZIP-приводов
...
2000/XP/2003/Vista/2008/7. Атрибут "Виртуальный" используется только в
...
используются только в Windows 2000/XP/2003/Vista/2008/7. Атрибут "Виртуальный"
используется только в Windows Vista/2008/7. Атрибуты "Сжатый" и
...
об оригинальной папке (только в NTFS/Windows 2000/XP/2003/Vista/2008/7). Если
...
2000/XP/2003/Vista/2008/7 для хранения дополнительных свойств файла. Файловые
