...
параметров.
   ...
   #Атрибуты#        Атрибуты включения и атрибуты исключения.
                   ...
                   #Виртуальный# используется только в Windows Vista/2008.
...
"Временный", "Символическая связь", "Автономный" и "Виртуальный" используются 
только на дисках с файловой системой NTFS. Причем, атрибуты "Зашифрованный", 
"Символическая связь" и "Автономный" используются только в Windows 
2000/XP/2003/Vista/2008. Атрибут "Виртуальный" используется только в 
Windows Vista/2008.
...
папки" будет недоступна.
    ...
    Атрибуты "Сжатый", "Зашифрованный", #Неиндексируемый#, #Разреженный#,
#Временный#, #Автономный# и #Виртуальный# доступны только на дисках с файловой
системой NTFS. Причем, атрибуты "Зашифрованный" и "Автономный" используются
только в Windows 2000/XP/2003/Vista/2008. Атрибут "Виртуальный" используется
только в Windows Vista/2008. Атрибуты "Сжатый" и "Зашифрованный"
