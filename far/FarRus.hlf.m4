...
предупреждение: "~Повторное открытие файла~@EditorReload@".
    ...
    3. ^<wrap>При создании нового файла используется WIN кодировка, изменить поведение
можно в меню ~Настройки редактора~@EditorSettings@.
  ...
  Прочие операции
   ...
   #Shift-F8#                ^<wrap>Выбор пользовательской таблицы символов (см. примечания)
   ...
   1. ^<wrap>Пользовательские таблицы символов находятся в папке
"Addons\\Tables" папки FAR в виде .reg файлов.
Перед использованием любой из таблиц ее нужно установить:
для этого просто нажмите #Shift-Enter# на соответствующем файле.
...
производится.
   ...
   4. ^<wrap>Если вы перетаскиваете имя файла из Проводника в редактор
...
версиях FAR.
   ...
   5. ^<wrap>Если блок не выделен, то #Ctrl-Ins#/#Ctrl-C# помечают текущую
