...
#Использовать фильтр#. Настройка условий ~фильтра~@Filter@ осуществляется
кнопкой #Фильтр#.
...
настройки расширенного набора свойств поиска. Для того чтобы быстро включить
или отключить эти параметры используется переключатель
...
значениями. Доступна для одиночного файлового объекта.
    ...
    Для ~символических связей~@HardSymLink@ (поддерживаемых только в
...
~пользовательские фильтры~@OpFilter@.

    Пользовательские фильтры можно добавлять, удалять, редактировать и
копировать с помощью клавиш #Ins#, #Del#, #F4# и #F5#. А также можно изменять
их порядок соответственно изменив их приоритет с помощью #Ctrl-Up# и
#Ctrl-Down#.
...
символом '-', и все удовлетворяющие им файлы будут исключены из панели файлов.
    Комбинация клавиш #Ctrl-F# позволяет изменять состояние разрешения на
фильтрацию папок. Если фильтрация папок разрешена то в заголовке меню будет
отображена строка "D?", а если запрещена то "D+".
    Клавиша #BS# снимет пометку с выбранного объекта, комбинация #Shift-BS#
снимет пометки со всех объектов.
    Комбинация клавиш #Shift-<Gray Minus># снимет все пометки, а также
выставит состояние разрешения на фильтрацию папок в запрещенное состояние.
...
буквы режима сортировки в верхнем левом углу панели.
    ...
    Для снятия фильтра с панели необходимо применить комбинацию клавиш
#Shift-BS# (то есть убрать все отметки "+" или "-" с пользовательских
фильтров и с масок файлов текущей панели) и нажать #Enter#.
...
переключатель #Использовать фильтр#. Настройка условий ~фильтра~@Filter@
