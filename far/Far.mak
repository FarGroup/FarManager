...
CPP_PROJ_COMMON=$(MP) $(COMPAT64) /W3 /nologo $(FAR_ALPHA_VERSION) $(USE_WFUNC) $(FAR_ANSI) $(FARSYSLOG) $(FARTRY) $(CREATE_JUNCTION) $(FAR_GR) $(DEFINES) /Gy /GF /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /J /c $(FARCMEM) $(FARALLOC) /FAcs /Fa"$(CODDIR)\\"
...
LINK32_FLAGS=$(LINK_COMMON) /incremental:no /fixed:no /machine:i386
ULINK_FLAGS=-B-
...
LINK32_FLAGS=$(LINK_COMMON) /debug /fixed:no /machine:I386
ULINK_FLAGS=-v -B-
