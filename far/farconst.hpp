...
/* Revision: 1.94 30.09.2005 $ */

/*
Modify:
  30.09.2005 SVS
    + CHECKEDPROPS_FLAGS - для CheckDisksProps()
  29.09.2005 SVS
...
enum CHECKEDPROPS_FLAGS{
  CHECKEDPROPS_ISSAMEDISK                   = 0x00000001,
  CHECKEDPROPS_DRIVETYPE                    = 0x00000002,
  CHECKEDPROPS_DRIVEFIXED                   = 0x00000004,
  CHECKEDPROPS_DRIVESUBSTITUTE              = 0x00000008,
  CHECKEDPROPS_NTFS                         = 0x00000010,
  CHECKEDPROPS_FS_NAMED                     = 0x00000020,
  CHECKEDPROPS_FS_CASE_IS_PRESERVED         = 0x00010000,
  CHECKEDPROPS_FS_CASE_SENSITIVE            = 0x00020000,
  CHECKEDPROPS_FS_UNICODE_STORED_ON_DISK    = 0x00040000,
  CHECKEDPROPS_FS_PERSISTENT_ACLS           = 0x00080000,
  CHECKEDPROPS_FS_FILE_COMPRESSION          = 0x00100000,
  CHECKEDPROPS_FS_VOL_IS_COMPRESSED         = 0x00200000,
  CHECKEDPROPS_FILE_NAMED_STREAMS           = 0x00400000,
  CHECKEDPROPS_FILE_READ_ONLY_VOLUME        = 0x00800000,
  CHECKEDPROPS_FILE_SUPPORTS_ENCRYPTION     = 0x01000000,
  CHECKEDPROPS_FILE_SUPPORTS_OBJECT_IDS     = 0x02000000,
  CHECKEDPROPS_FILE_SUPPORTS_REPARSE_POINTS = 0x04000000,
  CHECKEDPROPS_FILE_SUPPORTS_SPARSE_FILES   = 0x08000000,
  CHECKEDPROPS_FILE_VOLUME_QUOTAS           = 0x10000000,
};
