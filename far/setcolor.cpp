...
Modify:
  ...
  04.12.2000 SVS
    + ÿ³ýú²» ò üõý¾ - COL_DIALOG*DISABLED ø COL_WARNDIALOG*DISABLED
  22.11.2000 SVS
    + ÿ³ýú² ò üõý¾ - COL_DIALOGMENUSCROLLBAR - ÿþûþ¸ð ÿ¨þú¨³²úø ôû¿ ¸ÿø¸úð
  13.09.2000 tran 1.04
    + COL_COMMANDLINEPREFIX
  18.03.2000 tran 1.03
    + COL_VIEWERSCROLLBAR
  06.07.2000 SVS
    + -þò»ù ÿ³ýú² ôû¿ ýð¸²¨þùúø ¶òõ²þò
        COL_DIALOGMENUHIGHLIGHT
        COL_DIALOGMENUSELECTEDHIGHLIGHT
  29.06.2000 SVS
    + -þò»ù ÿ³ýú² ôû¿ ýð¸²¨þùúø ¶òõ²þò Menu ôû¿ Menu Scrollbar
  25.06.2000 SVS
...
void SetColors()
{
  ...
  /* $ 22.11.2000 SVS
    + ÿ³ýú² ò üõý¾ - COL_DIALOGMENUSCROLLBAR
  */
  /* $ 04.12.2000 SVS
    + ÿ³ýú² ò üõý¾ - COL_DIALOGDISABLED
  */
  struct MenuData DialogItems[]=
  {
    ...
    /* 06.07.2000 SVS
       + ôþñðòøû ò üõý¾ ôòð ¨ðýõõ "¸ú¨»²»µ ÿ³ýú²ð" :-)))
    */
    (char *)MSetColorDialogMenuHighLight,0,0,0,
    (char *)MSetColorDialogMenuSelectedHighLight,0,0,0,
    /* SVS $ */
    (char *)MSetColorDialogMenuScrollBar,0,0,0, // ÿþûþ¸ð ÿ¨þú¨³²úø ôû¿ ¸ÿø¸úð
  ...
  int WarnDialogPaletteItems[]={
    ...
    /* $ 29.06.2000 SVS
      -þò»ù ÿ³ýú² ôû¿ ýð¸²¨þùúø ¶òõ²þò Menu Scrollbar
    */
