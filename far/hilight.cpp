...
int HighlightFiles::EditRecord(int RecPos,int New)
{
  ...
  /* 01 */DI_CHECKBOX,5,2,0,2,0,0,DIF_AUTOMATION,0,(const wchar_t *)MHighlightMasks,
  /* 02 */DI_EDIT,5,3,63,3,1,(DWORD_PTR)HistoryName,DIF_HISTORY,0,L"",
  /* 03 */DI_TEXT,-1,4,0,4,0,0,DIF_BOXCOLOR|DIF_SEPARATOR,0,(const wchar_t *)MHighlightIncExcTitle,
  /* 04 */DI_CHECKBOX,5,5,0,5,0,0,DIF_3STATE,0,(const wchar_t *)MHighlightRO,
  /* 05 */DI_CHECKBOX,5,6,0,6,0,0,DIF_3STATE,0,(const wchar_t *)MHighlightHidden,
  /* 06 */DI_CHECKBOX,5,7,0,7,0,0,DIF_3STATE,0,(const wchar_t *)MHighlightSystem,
  /* 07 */DI_CHECKBOX,5,8,0,8,0,0,DIF_3STATE,0,(const wchar_t *)MHighlightArchive,
  /* 08 */DI_CHECKBOX,5,9,0,9,0,0,DIF_3STATE,0,(const wchar_t *)MHighlightCompressed,
  /* 09 */DI_CHECKBOX,5,10,0,10,0,0,DIF_3STATE,0,(const wchar_t *)MHighlightEncrypted,
  /* 10 */DI_CHECKBOX,35,5,0,5,0,0,DIF_3STATE,0,(const wchar_t *)MHighlightFolder,
  /* 11 */DI_CHECKBOX,35,6,0,6,0,0,DIF_3STATE,0,(const wchar_t *)MHighlightJunction,
  /* 12 */DI_CHECKBOX,35,7,0,7,0,0,DIF_3STATE,0,(const wchar_t *)MHighlightSparse,
  /* 13 */DI_CHECKBOX,35,8,0,8,0,0,DIF_3STATE,0,(const wchar_t *)MHighlightTemporary,
  /* 14 */DI_CHECKBOX,35,9,0,9,0,0,DIF_3STATE,0,(const wchar_t *)MHighlightNotIndexed,
  /* 15 */DI_TEXT,3,11,0,11,0,0,DIF_BOXCOLOR|DIF_SEPARATOR,0,L"",
  /* 16 */DI_TEXT,7,12,0,12,0,0,0,0,(const wchar_t *)MHighlightMarkChar,
  /* 17 */DI_FIXEDIT,5,12,5,12,0,0,0,0,L"",
  /* 18 */DI_TEXT,-1,13,0,13,0,0,DIF_BOXCOLOR|DIF_SEPARATOR,0,(const wchar_t *)MHighlightColors,
  /* 19 */DI_BUTTON,5,14,0,14,0,0,DIF_BTNNOCLOSE,0,(const wchar_t *)MHighlightNormal,
  /* 20 */DI_BUTTON,5,15,0,15,0,0,DIF_BTNNOCLOSE,0,(const wchar_t *)MHighlightSelected,
  /* 21 */DI_BUTTON,5,16,0,16,0,0,DIF_BTNNOCLOSE,0,(const wchar_t *)MHighlightCursor,
  /* 22 */DI_BUTTON,5,17,0,17,0,0,DIF_BTNNOCLOSE,0,(const wchar_t *)MHighlightSelectedCursor,
  /* 23 */DI_USERCONTROL,65-15-1,14,65-2,17,0,0,DIF_NOFOCUS,0,L"",
  /* 24 */DI_TEXT,3,18,0,18,0,0,DIF_BOXCOLOR|DIF_SEPARATOR,0,L"",
  /* 25 */DI_BUTTON,0,19,0,19,0,0,DIF_CENTERGROUP,1,(const wchar_t *)MOk,
  /* 26 */DI_BUTTON,0,19,0,19,0,0,DIF_CENTERGROUP,0,(const wchar_t *)MCancel
  };
