...
Modify:
  26.09.2001 SVS
    + Opt.AutoUpdateLimit -  выше этого количество не обновл€ть пассивную
      панель (если ее содержимое не равно активной).
  24.07.2001 IS
    ! ”точнение предыдущего изменени€ SVS. ѕервоначальный предложенный мною
      вариант не учитывал такую ситуацию, как пробелы, а потом им€ каталога в
      кавычках. “еперь заключение в кавычки происходит только, если строка не
