...
"Znak "{0}" ({1}) není vybranou kódovou stránkou podporován"
"Das Zeichen "{0}" ({1}) wird von der ausgewählten Codepage nicht unterstützt"
"Az "{0}" ({1}) karaktert a kiválasztott kódlap nem támogatja"
...
"Znak "{0}" ({1}) nie je podporovaný vybranou kódovou stránkou"
"Il carattere "{0}" ({1}) non è supportato dalla code page selezionata"
"Символ "{0}" ({1}) не підтримується вибраною кодовою сторінкою"
"Сімвал "{0}" ({1}) не падтрымліваецца выбранай кодавай старонкай"
"Pasirinktas kodo puslapis nepalaiko simbolio "{0}" ({1})"
"O caractere "{0}" ({1}) não é suportado pela página de código selecionada"

MByteSequenceIsNotSupportedByTheCodepage
"Последовательность байтов [{0}] не поддерживается выбранной кодовой страницей"
"The byte sequence [{0}] is not supported by the selected code page"
"Vybraná kódová stránka nepodporuje bajtovou sekvenci [{0}]"
"Die Bytefolge [{0}] wird von der ausgewählten Codepage nicht unterstützt"
"A kiválasztott kódlap nem támogatja az [{0}] bájtsorozatot"
"Sekwencja bajtów [{0}] nie jest obsługiwana przez wybraną stronę kodową"
"La secuencia de bytes [{0}] no es compatible con la página de códigos seleccionada"
"Vybraná kódová stránka nepodporuje bajtovú sekvenciu [{0}]"
"La sequenza di byte [{0}] non è supportata dalla pagina codici selezionata"
"Послідовність байтів [{0}] не підтримується вибраною кодовою сторінкою"
"Паслядоўнасць байтаў [{0}] не падтрымліваецца выбранай кодавай старонкай"
"Pasirinktas kodo puslapis nepalaiko baitų sekos [{0}]"
"A sequência de bytes [{0}] não é suportada pela página de código selecionada"
