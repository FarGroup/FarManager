...
MSetAttrTimeTitle1
l:
"ММ{0}ДД{1}ГГГГГ чч{2}мм{3}сс{4}мс"
"MM{0}DD{1}YYYYY hh{2}mm{3}ss{4}ms"
"MM{0}DD{1}RRRRR hh{2}mm{3}ss{4}ms"
upd:"MM{0}TT{1}JJJJJ hh{2}mm{3}ss{4}ms"
upd:"HH{0}NN{1}ÉÉÉÉÉ óó{2}pp{3}mm{4}ms"
upd:"MM{0}DD{1}RRRRR gg{2}mm{3}ss{4}ms"
"MM{0}DD{1}AAAAA hh{2}mm{3}ss{4}ms"
"MM{0}DD{1}RRRRR hh{2}mm{3}ss{4}ms"
"MM{0}DD{1}YYYYY hh{2}mm{3}ss{4}ms"
"ММ{0}ДД{1}РРРРР гг{2}хх{3}сс{4}мс"

MSetAttrTimeTitle2
"ДД{0}ММ{1}ГГГГГ чч{2}мм{3}сс{4}мс"
"DD{0}MM{1}YYYYY hh{2}mm{3}ss{4}ms"
"DD{0}MM{1}RRRRR hh{2}mm{3}ss{4}ms"
upd:"TT{0}MM{1}JJJJJ hh{2}mm{3}ss{4}ms"
upd:"NN{0}HH{1}ÉÉÉÉÉ óó{2}pp{3}mm{4}ms"
upd:"DD{0}MM{1}RRRRR gg{2}mm{3}ss{4}ms"
"DD{0}MM{1}AAAAA hh{2}mm{3}ss{4}ms"
"DD{0}MM{1}RRRRR hh{2}mm{3}ss{4}ms"
"DD{0}MM{1}YYYYY hh{2}mm{3}ss{4}ms"
"ДД{0}ММ{1}РРРРР гг{2}хх{3}сс{4}мс"

MSetAttrTimeTitle3
"ГГГГГ{0}ММ{1}ДД чч{2}мм{3}сс{4}мс"
"YYYYY{0}MM{1}DD hh{2}mm{3}ss{4}ms"
"RRRRR{0}MM{1}DD hh{2}mm{3}ss{4}ms"
upd:"JJJJJ{0}MM{1}TT hh{2}mm{3}ss{4}ms"
upd:"ÉÉÉÉÉ{0}HH{1}NN óó{2}pp{3}mm{4}ms"
upd:"RRRRR{0}MM{1}DD gg{2}mm{3}ss{4}ms"
"AAAAA{0}MM{1}DD hh{2}mm{3}ss{4}ms"
"RRRRR{0}MM{1}DD hh{2}mm{3}ss{4}ms"
"YYYYY{0}MM{1}DD hh{2}mm{3}ss{4}ms"
"РРРРР{0}ММ{1}ДД гг{2}хх{3}сс{4}мс"
