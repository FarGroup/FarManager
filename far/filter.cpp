...
int PanelFilter::EditRecord(char *Title,char *Masks)
{
  ...
  static struct DialogData EditDlgData[]=
  {
    ...
    /* 1 */ DI_TEXT,5,2,0,2,0,0,0,0,(char *)MEnterFilterTitle,
    /* 2 */ DI_EDIT,5,3,70,3,1,0,0,0,"",
    /* 3 */ DI_TEXT,5,4,0,4,0,0,0,0,(char *)MFilterMasks,
    /* 4 */ DI_EDIT,5,5,70,5,0,(DWORD_PTR)HistoryName,DIF_VAREDIT|DIF_HISTORY,0,"",
    /* 5 */ DI_TEXT,3,6,0,6,0,0,DIF_BOXCOLOR|DIF_SEPARATOR,0,"",
    /* 6 */ DI_BUTTON,0,7,0,7,0,0,DIF_CENTERGROUP,1,(char *)MOk,
    /* 7 */ DI_BUTTON,0,7,0,7,0,0,DIF_CENTERGROUP,0,(char *)MCancel
   };
